...
const countryAudios: Record<Language, Record<string, number>> = {
  ...
  ar: {
    ...
    'egypt': require('@/assets/countries/ar/egypt.mp3'),
    'france': require('@/assets/countries/ar/france.mp3'),
    'germany': require('@/assets/countries/ar/germany.mp3'),
    'ghana': require('@/assets/countries/ar/ghana.mp3'),
    'greece': require('@/assets/countries/ar/greece.mp3'),
    'india': require('@/assets/countries/ar/india.mp3'),
    'indonesia': require('@/assets/countries/ar/indonesia.mp3'),
    'italy': require('@/assets/countries/ar/italy.mp3'),
    'japan': require('@/assets/countries/ar/japan.mp3'),
    'kenya': require('@/assets/countries/ar/kenya.mp3'),
    'morocco': require('@/assets/countries/ar/morocco.mp3'),
    'nigeria': require('@/assets/countries/ar/nigeria.mp3'),
    'singapore': require('@/assets/countries/ar/singapore.mp3'),
    'south-africa': require('@/assets/countries/ar/southafrica.mp3'),
    'south-korea': require('@/assets/countries/ar/southkorea.mp3'),
    'spain': require('@/assets/countries/ar/spain.mp3'),
    'sweden': require('@/assets/countries/ar/sweden.mp3'),
    'tanzania': require('@/assets/countries/ar/tanzania.mp3'),
    'thailand': require('@/assets/countries/ar/thailand.mp3'),
    'uk': require('@/assets/countries/ar/uk.mp3'),
    'usa': require('@/assets/countries/ar/usa.mp3'),
  },
};
...
const fruitsAudios: Record<Language, Record<string, number>> = {
  ...
  ar: {
    ...
    'beans': require('@/assets/fruits_vegetables/ar/beans.mp3'),
    'broccoli': require('@/assets/fruits_vegetables/ar/broccoli.mp3'),
    'cabbage': require('@/assets/fruits_vegetables/ar/cabbage.mp3'),
    'carrot': require('@/assets/fruits_vegetables/ar/carrot.mp3'),
    'cherry': require('@/assets/fruits_vegetables/ar/cherry.mp3'),
    'corn': require('@/assets/fruits_vegetables/ar/corn.mp3'),
    'cucumber': require('@/assets/fruits_vegetables/ar/cucumber.mp3'),
    'grape': require('@/assets/fruits_vegetables/ar/grape.mp3'),
    'kiwi': require('@/assets/fruits_vegetables/ar/kiwi.mp3'),
    'lettuce': require('@/assets/fruits_vegetables/ar/lettuce.mp3'),
    'mango': require('@/assets/fruits_vegetables/ar/mango.mp3'),
    'onion': require('@/assets/fruits_vegetables/ar/onion.mp3'),
    'orange-fruit': require('@/assets/fruits_vegetables/ar/orange.mp3'),
    'pear': require('@/assets/fruits_vegetables/ar/pear.mp3'),
    'peas': require('@/assets/fruits_vegetables/ar/peas.mp3'),
    'pepper': require('@/assets/fruits_vegetables/ar/pepper.mp3'),
    'pineapple': require('@/assets/fruits_vegetables/ar/pineapple.mp3'),
    'potato': require('@/assets/fruits_vegetables/ar/potato.mp3'),
    'spinach': require('@/assets/fruits_vegetables/ar/spinach.mp3'),
    'strawberry': require('@/assets/fruits_vegetables/ar/strawberry.mp3'),
    'tomato': require('@/assets/fruits_vegetables/ar/tomato.mp3'),
    'watermelon': require('@/assets/fruits_vegetables/ar/watermelon.mp3'),
  },
};
...
const sportsAudios: Record<Language, Record<string, number>> = {
  ...
  ar: {
    ...
    'cricket': require('@/assets/sports/ar/cricket.mp3'),
    'curling': require('@/assets/sports/ar/curling.mp3'),
    'cycling': require('@/assets/sports/ar/cycling.mp3'),
    'diving': require('@/assets/sports/ar/diving.mp3'),
    'football': require('@/assets/sports/ar/football.mp3'),
    'handball': require('@/assets/sports/ar/handball.mp3'),
    'hockey': require('@/assets/sports/ar/hockey.mp3'),
    'ice-skating': require('@/assets/sports/ar/iceskating.mp3'),
    'kayaking': require('@/assets/sports/ar/kayaking.mp3'),
    'rowing': require('@/assets/sports/ar/rowing.mp3'),
    'rugby': require('@/assets/sports/ar/rugby.mp3'),
    'running': require('@/assets/sports/ar/running.mp3'),
    'sailing': require('@/assets/sports/ar/sailing.mp3'),
    'skiing': require('@/assets/sports/ar/skiing.mp3'),
    'sledding': require('@/assets/sports/ar/sledding.mp3'),
    'snowboarding': require('@/assets/sports/ar/snowboarding.mp3'),
    'soccer': require('@/assets/sports/ar/soccer.mp3'),
    'surfing': require('@/assets/sports/ar/surfing.mp3'),
    'swimming': require('@/assets/sports/ar/swimming.mp3'),
    'tennis': require('@/assets/sports/ar/tennis.mp3'),
    'volleyball': require('@/assets/sports/ar/volleyball.mp3'),
    'water-polo': require('@/assets/sports/ar/waterpolo.mp3'),
  },
};
...
const vehicleAudios: Record<Language, Record<string, number>> = {
  ...
  ar: {
    ...
    'boat': require('@/assets/vehicles/ar/boat.mp3'),
    'bus': require('@/assets/vehicles/ar/bus.mp3'),
    'canoe': require('@/assets/vehicles/ar/canoe.mp3'),
    'car': require('@/assets/vehicles/ar/car.mp3'),
    'drone': require('@/assets/vehicles/ar/drone.mp3'),
    'ferry': require('@/assets/vehicles/ar/ferry.mp3'),
    'glider': require('@/assets/vehicles/ar/glider.mp3'),
    'helicopter': require('@/assets/vehicles/ar/helicopter.mp3'),
    'hot-air-balloon': require('@/assets/vehicles/ar/hotairballoon.mp3'),
    'jet': require('@/assets/vehicles/ar/jet.mp3'),
    'rocket': require('@/assets/vehicles/ar/rocket.mp3'),
    'sailboat': require('@/assets/vehicles/ar/sailboat.mp3'),
    'ship': require('@/assets/vehicles/ar/ship.mp3'),
